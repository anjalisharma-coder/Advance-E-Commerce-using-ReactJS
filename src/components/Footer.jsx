...
const desc = "Eduaid theme number one world-class university in the world. Students are always studying at this university.";
                    ...
                    <div className="content">
                      ...
                      <ul className="lab-ul social-icons">
                        {socialList.map((val, i) => (
                          <li key={i}>
                            <a href={val.siteLink} className={val.className} aria-label={val.className}>
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>&copy; 2023 <Link to="/">ShopCart</Link> Designed by <a href="/" target="_blank" rel="noopener noreferrer">XYZ</a></p>
